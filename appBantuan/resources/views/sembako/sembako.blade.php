...
class="btn btn-small btn-secondary">Detail</a>
 <a href="{{route('sembako.edit',$data->id)}}" class="btn
btn-small btn-warning">Edit</a>
 <form action="{{route('sembako.destroy',$data->id)}}"
method="POST"
 onsubmit="return confirm('Apakah yakin menghapus
data ini?')">
@csrf
 @method('DELETE')
