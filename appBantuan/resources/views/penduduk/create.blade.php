...
placeholder="Tanggal Lahir" class="form-control" value="{{
...
placeholder="SD/SMP..." class="form-control" value="{{
...
placeholder="Pekerjaan" class="form-control" value="{{
...
placeholder="Penghasilan" class="form-control" value="{{
...
placeholder="Alamat Penduduk" class="form-control" value="{{
old('alamat') }}" required>
 </div>
 </div>
